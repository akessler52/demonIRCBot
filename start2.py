...
b1 = bots.Bot(name="kid_rush1", thrId=1, ablBits=(-1 & 0xFFFFFFFF), channels='#rush')
b2 = bots.Bot(name="kid_rush2", thrId=2, ablBits=(-1 & 0xFFFFFFFF), channels='#rush')
b3 = bots.Bot(name="kid_rush3", thrId=3, ablBits=(-1 & 0xFFFFFFFF), channels='#rush')
b4 = bots.Bot(name="kid_rush4", thrId=4, ablBits=(-1 & 0xFFFFFFFF), channels='#rush')
